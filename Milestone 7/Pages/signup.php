...
<html lang="en">
    ...
    <body class="bg-primary">
        <div class="church_auth">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group mt-4 mb-0"><a class="btn btn-primary btn-block" href="signup.php">Request Access</a></div>
                                        </form>
                                    </div>
            ...
            <div class="church_auth_footer">
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; ChurchDatabase 2020</div>
                            <div>
